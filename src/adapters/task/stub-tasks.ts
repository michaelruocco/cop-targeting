...
export const stubTasks: Task[] = [
  ...
  },
  {
    ...
    movement: {
      /*  id: 'APIPNR:CMID=15148b83b4fbba770dad11348d1c9b-2002',
        status: 'PRE_ARRIVAL',*/
      mode: MovementMode.RoRoAccompaniedFreight,
      ...
      goods: { description: 'PPE Masks', hazardous: false },
      haulier: {
  ...
  },
  {
    ...
    movement: {
      ...
      person: {
        ...
        movementStats: null,
        frequentFlyerNumber: '34893284D',
        ssrCodes: [],
      },
      otherPersons: [
        {
          entitySearchUrl: null,
          name: { first: 'Jim', last: 'Smith', full: 'Jim Smith' },
          role: PersonRole.Passenger,
          dateOfBirth: new Date('1988-06-09T00:00:00Z'),
          gender: 'F',
          nationality: null,
  ...
  },
  {
    ...
    movement: {
      /*  id: 'APIPNR:CMID=15148b83b4fbba770dad11348d1c9b-2002',
        status: 'PRE_ARRIVAL',*/
      mode: MovementMode.RoRoUnaccompaniedFreight,
